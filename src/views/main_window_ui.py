...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.menu_bar.setGeometry(QtCore.QRect(0, 0, 1416, 22))
        ...
        self.action_place_tiles_tool = QtWidgets.QAction(main_window)
        self.action_place_tiles_tool.setCheckable(True)
        self.action_place_tiles_tool.setEnabled(True)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/map.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_place_tiles_tool.setIcon(icon6)
        self.action_place_tiles_tool.setObjectName("action_place_tiles_tool")
        ...
        self.tool_bar.addAction(self.action_place_tiles_tool)
    ...
    def retranslateUi(self, main_window):
        ...
        self.action_place_tiles_tool.setText(_translate("main_window", "Place Tiles"))
        self.action_place_tiles_tool.setToolTip(_translate("main_window", "Place Tiles"))
