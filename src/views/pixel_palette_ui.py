...
class Ui_pixel_palette(object):
    def setupUi(self, pixel_palette):
        ...
        self.add_palette_row_btn = QtWidgets.QToolButton(pixel_palette)
        self.add_palette_row_btn.setEnabled(True)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/add_row.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_palette_row_btn.setIcon(icon)
        self.add_palette_row_btn.setObjectName("add_palette_row_btn")
        self.tool_layout.addWidget(self.add_palette_row_btn)
        self.remove_palette_row_btn = QtWidgets.QToolButton(pixel_palette)
        self.remove_palette_row_btn.setEnabled(True)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/remove_row.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.remove_palette_row_btn.setIcon(icon1)
        self.remove_palette_row_btn.setObjectName("remove_palette_row_btn")
        self.tool_layout.addWidget(self.remove_palette_row_btn)
